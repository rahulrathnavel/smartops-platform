...
# Configure kubectl
aws eks update-kubeconfig --region ap-south-1 --name ammazone-eks --profile sabari25
...
Write-Host "3. Tail audit logs: aws logs tail /smartops/agent/audit --follow --profile sabari25 --region ap-south-1" -ForegroundColor White
